...
export default function BibleReader() {
    ...
    return (
        ...
        >
            ...
            <div className={`fixed bottom-0 left-0 right-0 h-16 flex items-center justify-between px-6 z-50 sm:hidden transition-transform duration-300 pointer-events-none ${scrollDirection === 'down' && !isAtTop ? 'translate-y-full' : 'translate-y-0'}`}>
