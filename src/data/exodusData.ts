...
export const EXODUS_LOCATIONS: ExodusLocation[] = [
    // --- CONTEXT: JOSEPH'S LEGACY ---
    {
        ...
        type: 'place',
        links: [
            { label: 'Watch Video Explanation', url: 'https://www.youtube.com/watch?v=3f2nqErmcJs' },
            { label: '(Full "Patters of Evidence: Exodus" video)', url: 'https://www.patternsofevidence.com/exodus-film/' },
            { label: 'Archaeological Report', url: 'https://madainproject.com/avaris_statue' },
            { label: 'Tell el-Dab’a Wikipedia Article', url: 'https://en.wikipedia.org/wiki/Tell_el-Dab%27a' }
        ]
    },
    {
        id: 'bahr-yussef',
    ...
    // --- ACT I: THE ESCAPE ---
    {
        id: 'departure-rameses',
        category: 'journey',
        order: 1,
        title: "Departure from Rameses",
        narrative: "On the night of the Passover, under the full moon, the Israelites left Rameses in haste. A mixed multitude went up with them, carrying the bones of Joseph and the plunder of the Egyptians.",
        description: "The starting point of the Exodus. Rameses (Avaris) was the store city built by the Israelites.",
        coordinates: { lat: 30.8000, lng: 31.8500 }, // Slightly offset from Joseph's tomb
        bibleReferences: ["Exodus 12:37", "Numbers 33:3"],
        significance: "The beginning of the journey.",
        type: 'event'
    },
    {
        id: 'nuweiba-beach',
