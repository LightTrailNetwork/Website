...
import { ArrowLeft, ChevronDown, ChevronRight, BookOpen, Atom, Microscope, Search } from 'lucide-react';
import { useNavigate, useLocation } from 'react-router-dom';
import { SCIENCE_DATA } from '../../data/scienceData';

export default function ScienceStudy() {
    ...
    const [activeTab, setActiveTab] = useState(() => {
        ...
        const found = SCIENCE_DATA.find(c => c.id === hash);
        return found ? found.id : SCIENCE_DATA[0]!.id;
    });
    ...
    const activeCategory = SCIENCE_DATA.find(c => c.id === activeTab) || SCIENCE_DATA[0]!;
        ...
        <div className="max-w-7xl mx-auto pb-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1 text-lg">
                            Harmonizing the Book of God's Word with the Book of God's World.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-2">
                    <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest pl-3 mb-2">Categories</h3>
                    {SCIENCE_DATA.map(category => (
                        <button
                            key={category.id}
                            ...
                            <div key={entry.id} className="bg-card border border-border rounded-xl overflow-hidden shadow-sm group hover:shadow-md transition-shadow">
                                ...
                                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <div className="mb-3">
                                                <span className="text-xs font-bold text-muted-foreground uppercase">Biblical Truth:</span>
